...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/magnific-popup.css"> 
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/admin/jquery.gritter.css" rel="stylesheet">
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/datepicker/jquery.datepick.css" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/datepicker/jquery.plugin.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/datepicker/jquery.datepick.js"></script>
